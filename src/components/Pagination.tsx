...
const Pagination = ({
  ...
  return (
    <div className="w-full    h-10 px-4 py-2 bg-Primary-5 rounded-bl-xl rounded-br-xl">
      <div className="mx-auto flex w-full justify-center">
        <ul className="flex flex-row items-center gap-x-6 text-[0.75rem] leading-CS font-normal">
          <div className="flex">
          ...
          <div className="flex flex-row text-Gray-500 gap-2  ">
            {pages.map((page, index) => (
              <li
                key={index}
                className={`size-6 flex justify-center items-center  cursor-pointer hover:bg-Gray-50 rounded-lg px-4
                  ${
                    page === currentPage
                      ? "bg-Gray-50  rounded-lg px-4 font-bold text-[12px] leading-[21px] text-geantSap-black"
                      : ""
                  }
                `}
                onClick={() =>

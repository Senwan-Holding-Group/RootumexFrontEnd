              ...
              <div className="border-2 overflow-scroll  border-Primary-5 rounded-2xl">
                <table className="w-full  caption-bottom ">
                  ...
                  <tbody className=" [&_tr:last-child]:border-0 ">
                    {siteTransferDetailsFL?.transferLines?.map((item) => (
                      <tr
                        key={item.line}
              ...
              <div className="flex gap-x-8 ">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-x-2 items-center">
                    ...
                    <span className="text-RT-Black font-bold text-base leading-CS">
                      {siteTransferDetailsFL?.createdAt &&
                        format(new Date(siteTransferDetailsFL.createdAt), "PP")}
                    </span>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div className="flex gap-x-2 items-center">
                    ...
                    <span className="text-RT-Black font-bold text-base leading-CS">
                      {siteTransferDetailsFL?.updateAt &&
                        format(new Date(siteTransferDetailsFL.updateAt), "PP")}
                    </span>
                  </div>
                </div>
              </div>

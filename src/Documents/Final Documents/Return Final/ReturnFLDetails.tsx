              ...
              <div className="flex gap-x-16  ">
                <div className=" w-1/3 space-y-4 ">
                  <div className="space-y-1  ">
                    ...
                    <span
                      className={
                        " p-2 rounded-CS  text-Gray-500 border w-full inline-flex border-Secondary-500 font-medium text-base leading-CS h-10"
                      }>
                      {returnDetailsFL?.code}
                    </span>
                  </div>
                ...
                <div className=" w-1/3 space-y-4">
                  <div className="space-y-1  ">
                    ...
                    <span
                      ...
                      {returnDetailsFL?.docDate &&
                        format(new Date(returnDetailsFL.docDate), "PP")}
                    </span>
                  </div>
                  <div className="space-y-1  ">
                    <Label
                    ...
                    <span
                      ...
                      {returnDetailsFL?.docDueDate &&
                        format(new Date(returnDetailsFL.docDueDate), "PP")}
                    </span>
                  </div>
                  <div className="space-y-1  ">
                    <Label
              ...
              <div className="border-2 overflow-scroll  border-Primary-5 rounded-2xl">
                <table className="w-full  caption-bottom ">
                  ...
                  <tbody className=" [&_tr:last-child]:border-0 ">
                    {returnDetailsFL?.poLines?.map((item) => (
                      <tr
                        key={item.line}
              ...
              <div className="flex gap-x-8 ">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-x-2 items-center">
                    ...
                    <span className="text-RT-Black font-bold text-base leading-CS">
                      {returnDetailsFL?.created_at &&
                        format(new Date(returnDetailsFL.created_at), "PP")}
                    </span>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div className="flex gap-x-2 items-center">
                    ...
                    <span className="text-RT-Black font-bold text-base leading-CS">
                      {returnDetailsFL?.updated_at &&
                        format(new Date(returnDetailsFL.updated_at), "PP")}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="flex justify-end gap-x-4 px-6 py-4 border-t h-[4.5rem] border-Primary-15">
          <Button
            ...
            onClick={() => {
              ...
              setDialogConfig({
                title: "Close Return",
                description: "Are you sure you want to close this Return? ",
...
export default ReturnFLDetails;

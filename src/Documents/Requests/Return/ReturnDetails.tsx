...
const ReturnDetails = () => {
  ...
  useEffect(() => {
    if (returnDetails) {
      form.reset({
        docDueDate: new Date(returnDetails.docDueDate),
        warehouseCode: returnDetails.warehouseCode,
        projectCode: returnDetails.projectCode,
                  ...
                  <div className=" w-1/3 space-y-4">
                    <div className="space-y-1  ">
                      ...
                      <span
                        ...
                        {returnDetails?.docDate &&
                          format(new Date(returnDetails.docDate), "PP")}
                      </span>
                    </div>
                    <FormField
